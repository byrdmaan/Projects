...
$sql = "SELECT eventId FROM interested WHERE userId='$userId' ";
...
$response = array("bad"=>false, "errormsg"=>"Nothing is wrong because Sir Timmins is a genius!", "results"=>$results);
